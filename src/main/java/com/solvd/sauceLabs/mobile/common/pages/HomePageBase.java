...
public abstract class HomePageBase extends AbstractPage {
     ...
     */
    public int compareProductPrices(ProductListItemBase product1, ProductListItemBase product2) {

        BigDecimal product1Price = new BigDecimal(product1.getPrice().replaceAll("[^0-9.]", ""));
        BigDecimal product2Price = new BigDecimal(product2.getPrice().replaceAll("[^0-9.]", ""));
